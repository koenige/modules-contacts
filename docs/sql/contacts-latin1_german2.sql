...
CREATE TABLE `contacts_contacts` (
  ...
  `remarks` text COLLATE latin1_german2_ci,
  `sequence` tinyint(3) unsigned NOT NULL DEFAULT '1',
  `published` enum('yes','no') COLLATE latin1_general_ci NOT NULL DEFAULT 'no',
...
CREATE TABLE `contacts_verifications` (
  ...
  `confirmed_mail` varchar(127) COLLATE latin1_german2_ci DEFAULT NULL,
