...
/* 2026-06-27-1 */	CREATE TABLE `connections` (`connection_id` int unsigned NOT NULL AUTO_INCREMENT, `contact_id` int unsigned NOT NULL, `connected_contact_id` int unsigned NOT NULL, `last_update` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (`connection_id`), UNIQUE KEY `contact_id_connected_contact_id` (`contact_id`,`connected_contact_id`), KEY `contact_id` (`contact_id`), KEY `connected_contact_id` (`connected_contact_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
/* 2026-08-14-1 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&persons=1', '&use_for[contacts_persons]=1') WHERE `parameters` LIKE '%&persons=1%';
/* 2026-08-14-2 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&places=1', '&use_for[contacts_places]=1') WHERE `parameters` LIKE '%&places=1%';
/* 2026-08-14-3 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&organisations=1', '&use_for[contacts_organisations]=1') WHERE `parameters` LIKE '%&organisations=1%';
/* 2026-08-14-4 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&organisers=1', '&use_for[contacts_organisers]=1') WHERE `parameters` LIKE '%&organisers=1%';
/* 2026-08-14-5 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&contacts=1', '&use_for[contacts_general]=1') WHERE `parameters` LIKE '%&contacts=1%';
/* 2026-08-14-6 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&school=1', '&use_for[contact/school]=1') WHERE `parameters` LIKE '%&school=1%';
/* 2026-08-14-7 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&shop=1', '&use_for[shop]=1') WHERE `parameters` LIKE '%&shop=1%';
/* 2026-08-14-8 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&if[organisations][', '&if[contacts_organisations][') WHERE `parameters` LIKE '%&if[organisations][%';
/* 2026-08-14-9 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&if[organisers][', '&if[contacts_organisers][') WHERE `parameters` LIKE '%&if[organisers][%';
/* 2026-08-14-10 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&if[persons][', '&if[contacts_persons][') WHERE `parameters` LIKE '%&if[persons][%';
/* 2026-08-14-11 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&if[places][', '&if[contacts_places][') WHERE `parameters` LIKE '%&if[places][%';
/* 2026-08-14-12 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&if[school][', '&if[contact/school][') WHERE `parameters` LIKE '%&if[school][%';
/* 2026-08-14-13 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&if[contacts][', '&if[contacts_general][') WHERE `parameters` LIKE '%&if[contacts][%';
/* 2026-08-14-14 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&contacts_details_separate[organisations]=1', '&if[contacts_organisations][contacts_details_separate]=1') WHERE `parameters` LIKE '%&contacts_details_separate[organisations]=1%';
/* 2026-08-14-15 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&contacts_details_separate[places]=1', '&if[contacts_places][contacts_details_separate]=1') WHERE `parameters` LIKE '%&contacts_details_separate[places]=1%';
/* 2026-08-14-16 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&contacts_details_separate[persons]=1', '&if[contacts_persons][contacts_details_separate]=1') WHERE `parameters` LIKE '%&contacts_details_separate[persons]=1%';
/* 2026-08-14-17 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&contacts_details_separate[organisers]=1', '&if[contacts_organisers][contacts_details_separate]=1') WHERE `parameters` LIKE '%&contacts_details_separate[organisers]=1%';
/* 2026-08-14-18 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&contacts_details_separate[school]=1', '&if[contact/school][contacts_details_separate]=1') WHERE `parameters` LIKE '%&contacts_details_separate[school]=1%';
/* 2026-08-14-19 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&contacts_details_separate[shop]=1', '&if[shop][contacts_details_separate]=1') WHERE `parameters` LIKE '%&contacts_details_separate[shop]=1%';
/* 2026-08-14-20 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&organisations_params[', '&if[contacts_organisations][') WHERE `parameters` LIKE '%&organisations_params[%';
/* 2026-08-14-21 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&contacts_params[', '&if[contacts_general][') WHERE `parameters` LIKE '%&contacts_params[%';
/* 2026-08-14-22 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&organisations_reverse=1', '&if[contacts_organisations][reverse_relation]=1') WHERE `parameters` LIKE '%&organisations_reverse=1%';
/* 2026-08-14-23 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&persons_reverse=1', '&if[contacts_persons][reverse_relation]=1') WHERE `parameters` LIKE '%&persons_reverse=1%';
/* 2026-08-14-24 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&organisers_reverse=1', '&if[contacts_organisers][reverse_relation]=1') WHERE `parameters` LIKE '%&organisers_reverse=1%';
/* 2026-08-14-25 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&contacts_reverse=1', '&if[contacts_general][reverse_relation]=1') WHERE `parameters` LIKE '%&contacts_reverse=1%';
/* 2026-08-14-26 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&places_reverse=1', '&if[contacts_places][reverse_relation]=1') WHERE `parameters` LIKE '%&places_reverse=1%';
/* 2026-08-14-27 */	UPDATE categories SET `parameters` = REPLACE(`parameters`, '&school_reverse=1', '&if[contact/school][reverse_relation]=1') WHERE `parameters` LIKE '%&school_reverse=1%';
