...
/* 2026-08-15-1 */	UPDATE categories SET `category` = CONCAT(SUBSTRING_INDEX(SUBSTRING_INDEX(CONCAT(`parameters`, '&'), '&children[relation]=', -1), '&', 1), ' / ', SUBSTRING_INDEX(SUBSTRING_INDEX(CONCAT(`parameters`, '&'), '&parents[relation]=', -1), '&', 1)), `parameters` = CONCAT(IFNULL(`parameters`, ''), '&split_title=1') WHERE `parameters` LIKE '%&children[relation]=%' AND `parameters` LIKE '%&parents[relation]=%' AND `parameters` NOT LIKE '%&split_title=1%';
/* 2026-08-15-2 */	UPDATE categories SET `category` = CONCAT(SUBSTRING_INDEX(SUBSTRING_INDEX(CONCAT(`parameters`, '&'), '&children[relation]=', -1), '&', 1), ' / ', `category`), `parameters` = CONCAT(IFNULL(`parameters`, ''), '&split_title=1') WHERE `parameters` LIKE '%&children[relation]=%' AND `parameters` NOT LIKE '%&parents[relation]=%' AND `parameters` NOT LIKE '%&split_title=1%' AND SUBSTRING_INDEX(SUBSTRING_INDEX(CONCAT(`parameters`, '&'), '&children[relation]=', -1), '&', 1) != `category`;
/* 2026-08-15-3 */	UPDATE categories SET `category` = CONCAT(`category`, ' / ', SUBSTRING_INDEX(SUBSTRING_INDEX(CONCAT(`parameters`, '&'), '&parents[relation]=', -1), '&', 1)), `parameters` = CONCAT(IFNULL(`parameters`, ''), '&split_title=1') WHERE `parameters` LIKE '%&parents[relation]=%' AND `parameters` NOT LIKE '%&children[relation]=%' AND `parameters` NOT LIKE '%&split_title=1%' AND SUBSTRING_INDEX(SUBSTRING_INDEX(CONCAT(`parameters`, '&'), '&parents[relation]=', -1), '&', 1) != `category`;
/* 2026-08-15-4 */	UPDATE categories SET `parameters` = REGEXP_REPLACE(`parameters`, '&children\\[relation\\]=[^&]*', '') WHERE `parameters` LIKE '%&children[relation]=%';
/* 2026-08-15-5 */	UPDATE categories SET `parameters` = REGEXP_REPLACE(`parameters`, '&parents\\[relation\\]=[^&]*', '') WHERE `parameters` LIKE '%&parents[relation]=%';
